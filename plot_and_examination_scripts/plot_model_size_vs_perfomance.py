...
model_sizes = [8000000, 22000000, 57000000, 82000000, 132000000]
...
hit1_scores_with_neighbors = [[34.3, 48.4, 54.7, 57.2, 58.6], 
                             [ 15.4, 20.0, 22.3, 23.7, 24.1],
                             [ 30.7, 43.7, 52.4, 55.4, 56.1], 
                             [ 15.3, 20.0, 22.4, 23.5, 23.54]]
...
ax.plot(model_sizes, hit1_scores[0], label=f'WN18RR_with_neighbors', marker='o', color=viridis(0))
ax.plot(model_sizes, hit1_scores[1], label=f'FB15k237_with_neighbors', marker='o', color=viridis(1))
ax.plot(model_sizes, hit1_scores[2], label=f'WN18RR_no_neighbors', marker='o', color=viridis(2))
ax.plot(model_sizes, hit1_scores[3], label=f'FB15k237_no_neighbors', marker='o', color=viridis(3))
...
top_ticks = [8000000, 22000000, 57000000, 82000000, 132000000]
top_tick_labels = ['BERT-tiny', 'BERT-mini', 'BERT-small', 'BERT-medium', 'distilBERT']

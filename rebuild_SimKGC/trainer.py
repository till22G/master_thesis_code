...
class CustomTrainer:
    ...
    def __init__(self, args):
        ...
        train_dataset = Dataset(path=args.train_path)
        valid_dataset = Dataset(path=args.valid_path) if args.valid_path else None
        num_training_steps = args.num_epochs * len(train_dataset) // max(args.batch_size, 1)
    ...
    def eval_epoch(self, epoch) -> Dict:
        ...
        for i, batch_dict in enumerate(self.valid_loader):
            ...
            batch_size = len(batch_dict['batched_datapoints'])

...
from data_structures import collate_fn as collate
from data_structures import DataPoint, Dataset
...
from data_structures import create_tokenizer
...
class BertPredictor:
    ...
    @torch.no_grad()
    def predict_by_examples(self, examples: List[DataPoint]):
